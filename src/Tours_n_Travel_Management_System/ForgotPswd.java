...
public class ForgotPswd extends JFrame implements ActionListener{
	...
	public ForgotPswd() {
		...
		ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("Tours_n_Travel_Management_System/icons/forgotpassword.jpg"));
	...
	public void actionPerformed(ActionEvent ae){
		try{
			TnTDBConnection con = new TnTDBConnection();
			if(ae.getSource() == b1){
