...
public class ViewBookedHotel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					// Provide a default username for testing
					String defaultUsername = "test_username";
					ViewBookedHotel frame = new ViewBookedHotel(defaultUsername);
	...
	public ViewBookedHotel(String username) {
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Tours_n_Travel_Management_System/icons/bookedDetails.jpg"));
