...
public class CustomerRegistration extends JFrame implements ActionListener {
	...
	public CustomerRegistration(String username) {
		...
		getContentPane().setBackground(new Color(176, 224, 230)); // Changed background color

		JLabel lblName = new JLabel("ADD CUSTOMER DETAILS");
		lblName.setFont(new Font("Arial", Font.BOLD, 20)); // Changed font and size
		lblName.setBounds(300, 11, 250, 40); // Adjusted position
		add(lblName);
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Tours_n_Travel_Management_System/icons/newcustomer.jpg"));
