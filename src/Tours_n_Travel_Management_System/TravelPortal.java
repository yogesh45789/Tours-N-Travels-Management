...
public class TravelPortal extends JFrame implements ActionListener  {
	...
	public TravelPortal(String username){
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Tours_n_Travel_Management_System/icons/capy.png"));
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("Tours_n_Travel_Management_System/icons/home.jpg"));
		...
		JLabel text = new JLabel("Tours & Travel Management System");
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()== addPersonalDetails) {
			...
			new HotelReservation(username).setVisible(true);
